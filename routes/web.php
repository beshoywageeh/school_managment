    ...
    function () {
        Route::middleware('auth')->group(function () {
            ...
            Route::group(['prefix' => 'class_rooms', 'controller' => ClassRoomsController::class], function () {
                Route::get('/', 'index')->name('class_rooms.index');
            ...
            Route::group(['prefix' => 'parents', 'controller' => MyParentsController::class], function () {
                Route::get('/', 'index')->name('parents.index');
            ...
            Route::group(['prefix' => 'academic_year', 'controller' => AcadmiceYearController::class], function () {
                Route::get('/', 'index')->name('academic_year.index');
            ...
            Route::group(['prefix' => 'employees', 'controller' => UserController::class], function () {
                ...
                Route::get('/{id}/return', 'return_emp')->name('employees.return');
                Route::get('/{id}/show', 'show')->name('employees.show');
                Route::get('/return_list', 'return_list')->name('employees.return_list');
            ...
            Route::group(['prefix' => 'school_fees', 'controller' => SchoolFeeController::class], function () {
                Route::get('/', 'index')->name('schoolfees.index');
            ...
            Route::group(['prefix' => 'fee_invoice', 'controller' => fee_invoiceController::class], function () {
                Route::get('/', 'index')->name('fee_invoice.index');
            ...
            Route::group(['prefix' => 'Recipt_Payment', 'controller' => ReciptPaymentController::class], function () {
                Route::get('/', 'index')->name('Recipt_Payment.index');
...
Route::get('/payall','payall');
            ...
            Route::group(['prefix' => 'payment_parts', 'controller' => PaymentPartsController::class], function () {
                Route::get('/', 'index')->name('payment_parts.index');
            ...
            Route::group(['prefix' => 'reports', 'controller' => ReportController::class], function () {
                ...
                Route::get('/ExportStudents', 'export_students_view')->name('report.ExportStudents');
                Route::get('/ExportStudents/pdf', 'export_students_pdf')->name('report.ExportStudents.pdf');
                Route::get('/StockProducts', 'stock_products_view')->name('report.StockProducts');
                Route::get('/StockProducts/pdf', 'stock_products_pdf')->name('report.StockProducts.pdf');
                Route::get('/exception_fee', 'exception_fee_view')->name('report.exception_fee');
                Route::get('/exception_fee/pdf', 'exception_fee_pdf')->name('report.exception_fee.pdf');
                Route::get('/stock', 'stock_product_view')->name('report.stock');
                Route::get('/stock/pdf', 'stock_product_pdf')->name('report.stock.pdf');
                Route::get('/book_sheet_stock', 'book_sheet_stock_view')->name('report.book_sheet_stock');
                Route::get('/book_sheet_stock/pdf', 'book_sheet_stock_pdf')->name('report.book_sheet_stock.pdf');
                Route::get('/books_sheets', 'books_sheets')->name('report.books_sheets');
                Route::get('/student_report/{type}', 'student_report_view')->name('report.student_report');
                Route::get('/student_report/{type}/pdf', 'student_report_pdf')->name('report.student_report.pdf');
                Route::get('/student_tameen', 'student_tameen_view')->name('report.student_tameen');
                Route::get('/student_tameen/pdf', 'student_tameen_pdf')->name('report.student_tameen.pdf');
                Route::get('/clothes_stock', 'clothes_stocks')->name('reports.clothes_stock');
                Route::get('/clothes_stocks', 'clothes_stocks_view')->name('report.clothes_stocks');
                Route::get('/clothes_stocks/pdf', 'clothes_stocks_pdf')->name('report.clothes_stocks.pdf');
                Route::get('/payment_status', 'payment_status_view')->name('report.payment_status');
                Route::get('/payment_status/pdf', 'payment_status_pdf')->name('report.payment_status.pdf');
                Route::get('/fees_invoices', 'fees_invoices_view')->name('report.fees_invoices');
                Route::get('/fees_invoices/pdf', 'fees_invoices_pdf')->name('report.fees_invoices.pdf');
                Route::get('/payments', 'payments_view')->name('report.payments');
                Route::get('/payments/pdf', 'payments_pdf')->name('report.payments.pdf');
                Route::get('/payment_parts', 'payment_parts_view')->name('report.payment_parts');
                Route::get('/payment_parts/pdf', 'payment_parts_pdf')->name('report.payment_parts.pdf');
                Route::get('/credit', 'credit_view')->name('report.credit');
                Route::get('/credit/pdf', 'credit_pdf')->name('report.credit.pdf');
                Route::get('/school_fees', 'school_fees_view')->name('report.school_fees');
                Route::get('/school_fees/pdf', 'school_fees_pdf')->name('report.school_fees.pdf');
            });
            ...
            Route::group(['prefix' => 'admin_era', 'controller' => AdminEraController::class], function () {
                Route::get('/', 'index')->name('admin_era.index');
