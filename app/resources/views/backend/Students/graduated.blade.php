                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="flex items-center justify-center gap-2">
                                        @can('Student-restore')
                                            <a class="px-3 py-1 bg-green-500 text-white text-sm rounded-lg hover:bg-green-600"
                                        ...
                                        @endcan
                                        @can('Students-delete')
                                            <a class="px-3 py-1 bg-red-500 text-white text-sm rounded-lg hover:bg-red-600" onclick="confirmation(event)"
