...
@section('content')
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-4 border-b border-gray-100 flex justify-between items-center">
            <h4 class="text-lg font-bold text-gray-800">{{ trans('classes.title') }}</h4>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex items-center justify-center gap-1">
                                    ...
                                    <a href="{{ route('classes.show', $class->id) }}" class="p-2 text-primary hover:bg-primary/10 rounded-lg" title="{{ trans('general.info') }}">
                                    ...
                                    @can('classes-tammen')
                                    <a href="{{ route('classes.tammen', $class) }}" class="p-2 text-primary hover:bg-primary/10 rounded-lg" title="{{ trans('classes.tammen') }}">
                                        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
