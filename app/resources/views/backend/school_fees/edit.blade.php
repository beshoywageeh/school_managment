        ...
        <div class="col">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="form-with-multiple-column" class="max-w-full"
                        action="{{ route('school-fees.update', $school_fee->id) }}" method="post">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <x-input name='description' value="{{ $school_fee->description }}" class=''
                                    type='text'>{{ trans('fees.desc') }}</x-input>
                            </div>
                            <div class="col">
                                <x-input name='amount' class='' value="{{ $school_fee->amount }}"
                                    type='number'>{{ trans('fees.amount') }}</x-input>
                            </div>
                        </div>
                        <!-- Form Row: Two -->
                        <div class="row">
                            <div class="col">
                                ...
                                <select class='custom-select' name="grade_id" id="grades">
                                    ...
                                    @foreach ($grades as $grade)
                                        <option value="{{ $grade->id }}" @selected($school_fee->grade_id == $grade->id)>
                                            {{ $grade->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col">
                                ...
                                <select class='custom-select' name="classroom_id" id="classrooms">
                                    ...
                                    <option value="{{ $school_fee->classroom_id }}" selected>
                                        {{ $school_fee->classroom->name }}</option>
                                </select>
                            </div>
                            <div class="col">
                                <label class="" for="form-horizontal-full-name">
                                ...
                                <select class='custom-select' name="academic_year_id">
                                    <option value="{{ $school_fee->academic_year_id }}" selected>
                                        {{ $school_fee->year->view }}</option>
