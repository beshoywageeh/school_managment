        ...
        <div class="p-6">
            <form action="{{ route('exchange_bonds.update') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="note" id="note" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200" rows="3">{{ $exchange->note }}</textarea>
                </div>
