  ...
  <form id="form-with-multiple-column" class="max-w-full" action="{{ route('payment-parts.store') }}" x-data="{
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div class="flex align-center gap-4 mb-6">
            <input type="text" class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-100 text-gray-600" readonly value="{{ $student->fullName() }}">
                        ...
                        <table class="min-w-full  text-center">
                            ...
                            <td class="px-4 py-2">
                                <button type="button" x-on:click="removeRow(index)"
                                                class="p-2 text-red-400 hover:text-danger hover:bg-danger/10 rounded-lg transition-colors">
