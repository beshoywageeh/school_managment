<div class="modal" id="grade-edit-{{ $grade->id }}" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
                <h3 class="text-lg font-semibold text-gray-800">{{ trans('general.edit') }}</h3>
            ...
            <form action="{{ route('grade.update') }}" method="POST">
                ...
                <div class="p-6">
                    <div class="mb-4">
                        ...
                        <input type="text" name="Grade_Name" value="{{ $grade->name }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200" />
                    </div>
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 mb-1">{{ trans('Grades.select_res') }}</label>
                        <select multiple name="user_id[]" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200" id="tom-select">
