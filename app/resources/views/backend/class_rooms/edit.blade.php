<x-modal name="EditClassRoom-{{ $class_room->id }}" title="{{ trans('general.edit') }}">
            ...
            <div class="modal-body">
                <div class='form-group'>
                    ...
                    <select class="custom-select" name="grade_name">
                        <option value="" @disabled(true)>{{ trans('class_rooms.select_grade') }}
                        </option>
                        @foreach ($data['grades'] as $grade)
                            <option @selected($grade->id == $class_room->grade_id) value="{{ $grade->id }}">{{ $grade->name }}
                            </option>
                        @endforeach
                    </select>
                </div>
    ...
    <slot:footer>
        ...
        <button class="btn btn-secondary" type="button" x-on:click="open = false">{{ trans('general.Cancel') }}</button>
    </slot:footer>
      </form>
</x-modal>
