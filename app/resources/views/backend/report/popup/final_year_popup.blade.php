<div class="modal fade" id="final_year" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <div class="modal-title" id="exampleModalLabel">
                    <div class="">
                        <h6>{{ trans('report.finalyear.title') }}</h6>
                    </div>
                </div>
            ...
            <form action="{{route('report.final_year')}}" method="post">
                <div class="modal-body">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-9">
                            <select name="grade[]" id="" class="custom-select select2 w-100 grades" multiple style="width: 100%;">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-9">
                            <select name="classroom[]" id="" class="custom-select w-100 classrooms select2" multiple style="width: 100%;">
