<div id="payments-modal" x-data="{ open: false }" x-cloak>
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2">
                            <input type="text" class="flex-1 rounded-lg border border-gray-300 px-3 py-2.5 text-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition-all range-from" name="from" placeholder="{{ trans('general.from') }}">
                            <span class="text-gray-500">-</span>
                            <input class="flex-1 rounded-lg border border-gray-300 px-3 py-2.5 text-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition-all range-to" type="text" name="to" placeholder="{{ trans('general.to') }}">
                        </div>
                    </div>
                </div>
