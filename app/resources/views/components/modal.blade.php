...
<div x-data="{ open: false }" x-on:keydown.escape.window="open = false" class="inline-block">
    ...
    <div x-show="open" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0"
        ...
        class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4" x-on:click.self="open = false"
        style="display: none;">
        ...
        <div x-show="open" x-transition:enter="transition ease-out duration-300"
            ...
            class="bg-white rounded-xl shadow-xl w-full overflow-hidden transition-all {{ $sizes }}">
