import{f as r}from"./app-3962e19f.js";/* empty css            */const l=document.querySelector("#table-products"),o=document.querySelector("#btn-add-item"),n=document.querySelectorAll(".btn-remove-item"),i=`
  <tr>
    <td>
