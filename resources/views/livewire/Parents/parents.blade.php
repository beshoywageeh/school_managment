...
<x-input name='Father_Name' wire:model='Father_Name' class='' type='text'>{{
                            trans('Parents.Father_Name') }}</x-input>
                        <x-input name='Father_Phone' wire:model='Father_Phone' class='' type='text'>{{
                            trans('Parents.Father_Phone') }}</x-input>
                        <!-- Form Column: Father_Job -->
<x-input name='Father_Job' wire:model='Father_Job' class='' type='text'>{{
                            trans('Parents.Father_Job') }}</x-input>
                        </div>
                        <!-- Form Row: Two -->

<div class="flex flex-col items-center w-full gap-4 md:flex-row">
<x-input name='Father_National_Id' wire:model='Father_National_Id' class='' data="Father_National_Id" type='text'>{{
    trans('Parents.Father_National_Id') }}
</x-input>
<x-input name='Father_Birth_Date' wire:model='Father_Birth_Date' class="input-date" type='date'>{{
    trans('Parents.Father_Birth_Date') }}</x-input>
<x-input name='Father_Learning' wire:model='Father_Learning' class="" type='text'>{{
...
<div class="flex flex-col items-center w-full gap-4 md:flex-row">
    <!-- Form Column: Username -->
<x-input name='Mother_Name' wire:model='Mother_Name' class='' type='text'>{{
    trans('Parents.Mother_Name') }}</x-input>
<x-input name='Mother_Phone' wire:model='Mother_Phone' class='' type='text'>{{
    trans('Parents.Mother_Phone') }}</x-input>
<x-input name='Mother_Job' wire:model='Mother_Job' class='' type='text'>{{
    trans('Parents.Mother_Job') }}</x-input>
</div>
<!-- Form Row: Two -->
<div class="flex flex-col items-center w-full gap-4 md:flex-row">
<x-input name='Mother_National_Id' wire:model='Mother_National_Id' class='' type='text'>{{
    trans('Parents.Mother_National_Id') }}</x-input>
<x-input name='Mother_Birth_Date' wire:model='Mother_Birth_Date' class='input-date' type='date'>{{
...
<button class="btn btn-soft-secondary" type="button" wire:click='create_mode'>{{
