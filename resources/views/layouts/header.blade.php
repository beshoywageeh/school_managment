<div>
    <header class="header">
        <div class="flex justify-between items-center container-fluid">
            ...
            <div class="flex overflow-visible items-center space-x-6">
            ...
            <div class="flex items-center">
                ...
                <div class="-mt-0.5 dropdown" data-strategy="absolute">
                    <div class="px-3 dropdown-toggle">
                        <button
                            class="flex relative justify-center items-center mt-1 rounded-full transition-colors duration-150 text-slate-500 hover:text-slate-700 focus:text-primary-500 dark:text-slate-400 dark:hover:text-slate-300 dark:focus:text-primary-500">
                        ...
                        <div class="w-full h-80" data-simplebar>
                            <ul>
                                <li
                                    ...
                                    <div
                                        class="flex flex-shrink-0 justify-center items-center w-10 h-10 text-green-500 bg-green-100 rounded-full">
                                    ...
                                    <div>
                                        ...
                                        <p class="flex gap-1 items-center mt-1 text-xs text-slate-400">
                ...
                <div class="dropdown" data-strategy="absolute">
                    <div class="pl-3 dropdown-toggle">
                        <button class="flex relative gap-x-1.5 items-center group" type="button">
                            <div class="avatar avatar-circle avatar-indicator avatar-indicator-online">
                                <img class="avatar-img group-focus-within:ring group-focus-within:ring-primary-500"
                                    src="{{ URL::asset('assests/images/Sidebar/avatar3.png') }}" alt="Avatar 1" />
                            </div>
                        </button>
                    </div>

                    <div class="mt-1 w-56 divide-y dropdown-content dark:divide-slate-600">
                        <div class="px-4 py-3">
                        ...
                        <div class="py-1">
                            <a href="{{ route('setting.index') }}" class="dropdown-link">
                                <i width="18" height="18" data-feather="settings" class="text-slate-500"></i>
                                <span>{{ trans('setting.title') }}</span>
                            </a>
                        </div>
                        <div class="py-1">
