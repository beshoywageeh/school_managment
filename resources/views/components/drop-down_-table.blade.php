...
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
    stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit text-primary-600">
...
{{ trans('general.edit') }}
                ...
                @isset($delete)
<li class="dropdown-list-item">
<button class="dropdown-link" wire:click="Delete({{ $data }})"><svg xmlns="http://www.w3.org/2000/svg" width="24"
        ...
        <line x1="14" y1="11" x2="14" y2="17"></line>
                ...
                @isset($info)
<li class="dropdown-list-item">
<button wire:click="Information({{ $data }})" class="dropdown-link"><svg xmlns="http://www.w3.org/2000/svg" width="24"
        height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
        stroke-linejoin="round" class="feather feather-info">
        <circle cx="12" cy="12" r="10"></circle>
        <line x1="12" y1="16" x2="12" y2="12"></line>
        <line x1="12" y1="8" x2="12.01" y2="8"></line>
</svg> {{ trans('general.info') }} </button>
                    </li>
                @endisset
