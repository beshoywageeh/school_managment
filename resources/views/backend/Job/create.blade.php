                                    ...
                                    <div class="form-group">
                                        <div class="text-left checkbox checbox-switch switch-info">
                                            <label>{{ trans('jobs.is_main') }}
                                                <input type="checkbox" name="is_main" id="is_main" checked>
                                                <span></span>
                                            </label>
                                        </div>
                                    </div>
                                </td>
                                <td><x-input name="job_name" label="job_name" type="text"
                                ...
                                <td>
                                    <div id="main_jobs">
                                        ...
                                        <select id="worker_type" class="custom-select" name="type">
                                            <option value="" disabled selected>{{ trans('general.worker_type') }}
                                            </option>
                                            @foreach ($jobs_main as $job_type)
                                                <option value="{{ $job_type->id }}" @selected(old('is_main', $job_type->id) == $job_type->id)>
